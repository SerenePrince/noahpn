              ...
              >
                ...
                <div className="max-w-2xl min-w-0 text-center lg:text-left">
                  ...
                  <p className="mt-6 text-base leading-relaxed lg:text-lg">
                    I'm a developer and computer science student born and raised
                    in BC, currently living in Ottawa for school.
                  </p>
                  <p className="mt-4 text-base leading-relaxed lg:text-lg">
                    I started coding at 17 in a beginner programming class
                    during my senior year of high school and immediately felt a
                    connection. After graduating I worked full-time to save
                    money and completed the math prerequisites needed for
                    college.
                  </p>
                  <p className="mt-4 text-base leading-relaxed lg:text-lg">
                    Now, what I enjoy most about development is the final
                    stretch of MVP work — when messy planning notes turn into
                    something tangible and the big picture finally clicks.
                  </p>
                  <p className="mt-4 text-base leading-relaxed lg:text-lg">
